...
export const DEFAULT_STYLES: readonly StyleDef[] = [
  ...
  { id: 'jazz', name: 'Jazz 爵士', note: '线条长、延伸多、爆发力强，底子是爵士乐和百老汇舞台，特别讲究表情和态度。' },
  {
    id: 'breaking',
    name: 'Breaking 霹雳舞',
    note: '分 Toprock、Footwork、Freeze、Powermove 四块，跳的人叫 B-Boy / B-Girl。2024 巴黎奥运会它是正式项目。',
  },
  { id: 'popping', name: 'Popping 震感舞', note: '靠肌肉瞬间收紧再放松做出一顿一顿的质感，常配 Funk 音乐；「机器人」只是它的一种玩法。' },
  { id: 'locking', name: 'Locking 锁舞', note: '动作做到一半突然「锁」住定格，配着指、拍手、转手腕，是看着最开心的舞种之一。' },
  { id: 'waacking', name: 'Waacking 甩手舞', note: '70 年代洛杉矶 Disco 地下长出来的，手臂快速甩、Pose 要狠，本来就是表达态度和情绪的舞。' },
  { id: 'house', name: 'House 浩室', note: '跟着 4/4 拍的 House 音乐走，脚步碎、快、流畅，上身放松，跳起来像一直在往前跑。' },
]
